...
import 'brands_rail_widegt.dart';
...
class ContentSpace extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final productsByBrand = productsData.findByBrand(brand);

    if (brand == 'All') {
      for (int i = 0; i < productsData.getListProduct.length; i++) {
        productsByBrand.add(productsData.getListProduct[i]);
      }
    }
          ...
          child: productsByBrand.isEmpty
              ? Column(
                  ...
                  children: [
                    ...
                    Text(
                      'No product related to this brand',
